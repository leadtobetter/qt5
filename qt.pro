...
addModule(qtdatavis3d, qtbase qtdeclarative, , qtdatavisualization.pro)
addModule(qtcharts, qtbase qtdeclarative, , qtcharts.pro)
addModule(qtdeclarative-render2d, qtbase qtdeclarative, , scenegraph-raster.pro)
addModule(qtvirtualkeyboard, qtbase qtdeclarative qtmultimedia qtquickcontrols qtsvg, , virtualkeyboard.pro)
